...
<body>
    <div class="container">
        ...
        <h3 class="text-center mb-15">Sales Ticket Period</h3>
        <table style="width: 100%;border-collapse: collapse;border: 1px solid #333;">
             <thead>
                <tr>
                    <th class="text-center" style="width: 4%">No</th>
                    <th class="text-center" style="width: 10%">No Invoice</th>
                    <th class="text-center" style="width: 10%">Passenger</th>
    ...
    @php
        ...
        $total_discount += isset($invoice->discount) ? $invoice->discount : 0;
    @endphp
    <tr>
